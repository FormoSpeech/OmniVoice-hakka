...
# Evaluate the cln + denoised-reading OmniVoice checkpoint on the custom
# FormoSpeech Hakka test list.
#
...
# ====== Modify as needed ======
CHECKPOINT="${REPO_ROOT}/exp/omnivoice_finetune_formospeech_hakka_cln_plus_denoised_reading/checkpoint-5000"
...
RES_DIR="${REPO_ROOT}/exp/eval_hakka_cln_plus_denoised_reading_$(basename "${CHECKPOINT}")"
...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
    echo "Stage 1: Batch inference on custom Hakka test list (cln + denoised reading checkpoint)"
