...
# Evaluate a fine-tuned OmniVoice checkpoint on the custom FormoSpeech Hakka test list.
#
...
# ====== Modify as needed ======
CHECKPOINT="${REPO_ROOT}/exp/omnivoice_finetune_formospeech_hakka/checkpoint-5000"
TEST_LIST="${REPO_ROOT}/data/formospeech_hakka/dev_test_list.jsonl"
RES_DIR="${REPO_ROOT}/exp/eval_hakka_$(basename "${CHECKPOINT}")"
...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
    echo "Stage 1: Batch inference on custom Hakka test list"
