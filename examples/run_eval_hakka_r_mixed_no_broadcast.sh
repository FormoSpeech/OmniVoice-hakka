...
# Evaluate the r_mixed_no_broadcast Hakka checkpoint on the custom FormoSpeech Hakka test list.
...
CHECKPOINT="${REPO_ROOT}/exp/omnivoice_finetune_formospeech_hakka_r_mixed_no_broadcast/checkpoint-5000"
TEST_LIST="${REPO_ROOT}/data/formospeech_hakka/dev_test_list.jsonl"
RES_DIR="${REPO_ROOT}/exp/eval_hakka_r_mixed_no_broadcast_$(basename "${CHECKPOINT}")"
